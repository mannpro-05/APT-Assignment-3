...
/** This class contains all the strings which will be used to get the path of the files */
public class Constants {
    //This is the path to the dataset.
    public static final String FILE_PATH = "dataset/Indiegogo.csv";
    //this is the path to the brutePlot.csv
